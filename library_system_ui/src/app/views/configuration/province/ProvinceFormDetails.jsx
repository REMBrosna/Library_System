...
const ProvinceFormDetails = () => {
    ...
    useEffect(() => {
        setLoading(false);
        if (viewType !== "new") {
            sendRequest("api/v1/library/mst/entity/province/" + provinceId, "getProvince", "get", {});
        }
    }, [provinceId, viewType]);
    ...
    const handleSubmit = async (values) => {
        ...
        switch (viewType) {
            ...
            case "edit":
                sendRequest("api/v1/library/mst/entity/province/" + provinceId, "updateProvince", "put", {
                    ...inputData,
                });
                break;
            default:
    ...
    const handleActiveChange = (e) => {
        setTimeout(
            () =>
                sendRequest(
                    "api/v1/library/mst/entity/province/" + provinceId + "/activate",
                    "activate",
                    "put",
                    inputData
                ),
    ...
    const handleDeActiveChange = (e) => {
        setTimeout(
            () => sendRequest("api/v1/library/mst/entity/province/" + provinceId, "deActive", "delete", {}),
            1000
        );
    };
