...
export const registerTabs = [
    ...
    // { text: "common:register.tabs.logo.title", icon: < Assignment /> },
...
export const APPLICATION_URL = "api/pedi/mst/numberApplication";
export const CUSTOMER_URL = "/api/pedi/mst/numberCustomers/";
export const USERS_URL = "/api/pedi/mst/numberUsers/";
export const BOOKS_URL = "/api/pedi/mst/numberBooks/";
export const ITEMS_URL = `/api/pedi/mst/numberItems/`;
...
export const MST_OFFICE_CODE_AUTOCOMPLETE = "/api/pedi/mst/officeCode";
